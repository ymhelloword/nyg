...
<div class="content">
    <div class="classification">
        <div class="commodity-classification clear-float">
            <ul>
                <li><a href="<%=path%>/supply">全部分类</a></li>
                <li><a href="<%=path%>/supply/fruit">水果</a></li>
                <li ><a id="vegetable" href="<%=path%>/supply/vegetables">蔬菜</a></li>
                <li><a href="<%=path%>/supply/dami">大米</a></li>
                <li><a href="<%=path%>/supply/mine">葡萄酒</a></li>
                <li><a href="<%=path%>/supply/zzzm">种子种苗</a></li>
                <li><a href="<%=path%>/supply/zyc">中药材</a></li>
                <li><a href="<%=path%>/supply/nznj">农资农机</a></li>
            </ul>
        </div>
        <c:if test="${sortnav eq 'all'}">
            <%@include file="public/supply/sort_fruit.jsp"%>
            <%@include file="public/supply/sort_vegetable.jsp"%>
        </c:if>
        <c:if test="${sortnav eq 'fruit'}">
            <%@include file="public/supply/sort_fruit.jsp"%>
        </c:if>
        <c:if test="${sortnav eq 'vegetable'}">
            <%@include file="public/supply/sort_vegetable.jsp"%>
        </c:if>
    </div>
        ...
        <ul class="hot-ul" id="hot_ul">
            <c:forEach items="${products}" var="product">
                <li>
                    ...
                    <img src="<%=ip_port%>${product.productPicInfo.picUrl}" class="hot-img" alt="">
